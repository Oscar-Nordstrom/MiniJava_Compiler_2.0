...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    OR = 285,                      // OR
    AND = 286,                     // AND
    EQUALEQUAL = 287,              // EQUALEQUAL
    LESSTHAN = 288,                // LESSTHAN
    MORETHAN = 289,                // MORETHAN
    PLUSOP = 290,                  // PLUSOP
    MINUSOP = 291,                 // MINUSOP
    NOT = 292,                     // NOT
    MULTOP = 293,                  // MULTOP
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_OR = 30,                               // OR
        S_AND = 31,                              // AND
        S_EQUALEQUAL = 32,                       // EQUALEQUAL
        S_LESSTHAN = 33,                         // LESSTHAN
        S_MORETHAN = 34,                         // MORETHAN
        S_PLUSOP = 35,                           // PLUSOP
        ...
        S_goal = 44,                             // goal
        S_classList = 45,                        // classList
        S_mainClass = 46,                        // mainClass
        S_classDeclaration = 47,                 // classDeclaration
        S_varDeclarationList = 48,               // varDeclarationList
        S_varDeclaration = 49,                   // varDeclaration
        S_argumentList = 50,                     // argumentList
        S_argument = 51,                         // argument
        S_arg = 52,                              // arg
        S_methodDeclarationList = 53,            // methodDeclarationList
        S_methodDeclaration = 54,                // methodDeclaration
        S_methodBodyList = 55,                   // methodBodyList
        S_methodBody = 56,                       // methodBody
        S_type = 57,                             // type
        S_ifStatement = 58,                      // ifStatement
        S_statementList = 59,                    // statementList
        S_statement = 60,                        // statement
        S_expressionListComma = 61,              // expressionListComma
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_MORETHAN (std::string v)
      {
        return symbol_type (token::MORETHAN, std::move (v));
      }
#else
      static
      symbol_type
      make_MORETHAN (const std::string& v)
      {
        return symbol_type (token::MORETHAN, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
